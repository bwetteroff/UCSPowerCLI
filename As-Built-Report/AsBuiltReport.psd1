#
# Module manifest for module 'AsBuiltReport'
#
...
PrivateData = @{
    ...
    PSData = @{
        ...
        LicenseUri = 'https://github.com/tpcarman/As-Built-Report/blob/master/LICENSE'

        # A URL to the main website for this project.
        ProjectUri = 'https://github.com/tpcarman/As-Built-Report'
