...
Style -Name 'Heading 1' -Size 16 -Color '00AEEF' 
Style -Name 'Heading 2' -Size 14 -Color '00AEEF' 
Style -Name 'Heading 3' -Size 12 -Color '00AEEF' 
Style -Name 'Heading 4' -Size 11 -Color '00AEEF' 
Style -Name 'Heading 5' -Size 10 -Color '00AEEF'
Style -Name 'H1 Exclude TOC' -Size 16 -Color '00AEEF' 
Style -Name 'Normal' -Size 10 -Color '000000' -Default
Style -Name 'TOC' -Size 16 -Color '00AEEF' 
Style -Name 'TableDefaultHeading' -Size 10 -Color 'FAF7EE' -BackgroundColor '002D5B' 
